...
router.get('/hybrid/topic_reply/:id', proxy('http://backend.test.env', {
...
此时访问 __http://[我的域名]/hybrid/topic_reply/:id__ 可请求到 __http://backend.test.env/hybrid/topic_reply/:id__ 的数据。其中 __data__ 可随意修改，__return__ 值为请求返回值。
